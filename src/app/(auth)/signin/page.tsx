			...
			<div className='flex gap-8 flex-col p-6 items-center min-h-1/3 rounded-2xl w-1/2 border-[#252525] border-[1px]'>
				...
				<div className='flex gap-1 w-full'>
					<button
						...
						className='flex py-1 justify-center items-center gap-2 w-1/2 border-[#252525] border-[1px] rounded-[6px] '
					>
				...
				<form className='formR flex-col' onSubmit={handleSubmit(onSubmit)}>
