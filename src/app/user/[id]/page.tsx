	...
	return (
		<div className='flex'>
			{currentUser && !notFound ? (
				<div
					className={`flex flex-col mt-16 gap-2 sm:px-[20px] md:px-[60px] xl:px-[200px] items-center justify-start w-screen min-h-screen ${outfit.className}`}
				>
					<div className='flex flex-col items-center w-full'>
						...
						>
							{owner && (
								<div className='flex size-8 bg-[--background-color] rounded-full justify-center items-center'>
					...
					>
						<div className='flex-col text-2xl justify-center text-center items-center w-1/3'>
							...
							<div className='w-full gap-3 mt-6 grid grid-cols-2 grid-flow-row'>
								{currentUser.products.map((p, index) => (
									<div
										key={index}
						...
						<div className='flex-col text-2xl justify-center items-center text-center w-1/3'>
							...
							<div className='flex flex-col mt-6'>
								{currentUser.orders.map((o, index) => (
									<OrderComponent key={index} order={o} />
								))}
							</div>
						</div>
					</div>
